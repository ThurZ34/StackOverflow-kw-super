...
<template>
    <nav class="navbar navbar-expand-lg navbar-laravelflow">
        <div class="container">
            <a class="navbar-brand" href="/">Kawe<strong>Super</strong></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <Link class="nav-link" :class="{ active: route().current('questions.*')}" aria-current="page" :href="route('questions.index')">Questions</Link>
                    </li>
                    <li class="nav-item">
                        <Link class="nav-link" :class="{ active: route().current('tags.*')}" :href="route('tags.index')">Tags</Link>
                    </li>
                </ul>
